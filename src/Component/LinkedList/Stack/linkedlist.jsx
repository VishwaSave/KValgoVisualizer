    ...
    if (list.length != 0) {
      ...
      list.map((val, ind) => {
        if (ind != 0 && ind != list.length - 1) {
          let ao = document.getElementById(`title${ind}`);
          ao.innerHTML = "";
        }
  ...
  async function insertB(m) {
    ...
    if (list.length == 0) {
      ...
      <div class="flex">
                    <div class="absolute">
                      <div
                        class="w-[4rem] max-lg:w-[5rem] text-center text-red-700 z-50 relative right-[90px]"
        id="title0"
      ><b>vtx</b></div></div>
      <div
      class="w-[4rem] h-[1rem] max-lg:w-[5rem] mb-5 pb-[1.4rem] max-lg:pb-[2.1rem] text-center border-4 border-black border-yellow-500 bg-yellow-500 rounded-[50%] z-10 font-extrabold"
      id="bar0"
      >
      ${m}
      </div>
      ...
      ><b>head/0</b></div></div>
      <div
      class="w-[4rem] h-[1rem] max-lg:w-[5rem] mb-5 pb-[1.4rem] max-lg:pb-[2.1rem] text-center border-4 border-black border-green-500 bg-green-500 rounded-[50%] z-10 font-extrabold"
      id="bar0"
      >
      ${m}
      </div>
      ...
      <div class="absolute hidden">
        <hr
          class="w-1 h-5 bg-black bg-yellow-500 border-0 relative top-[-21px] left-8 transition ease-in-out duration-[3s] arrow-0"
        />
      </div>
      <div class="absolute hidden">
        <hr
          class="w-1 h-3 bg-black border-0 relative top-[-10px] left-[34px] rotate-45 arrow-0"
        />
      </div>
      <div class="absolute hidden">
        <hr
          class="w-1 h-3 bg-black border-0 relative top-[-10px] left-[29px] rotate-[140deg] arrow-0"
        />
      </div>`;
      await new Promise((resolve) => {
        msg.addEventListener("end", () => {
      ...
      n.children[0].children[0].children[0].children[0].innerHTML = `<b>head/0</b>`;
      for (let i = 0; i < list.length; i++) {
        n = document.getElementById("barContainer");
        a[i].id = "bar" + (i + 1);
        for (let j = 1; j < 4; j++) {
          n.children[i].children[j].children[0].classList.remove("arrow-" + i);
          n.children[i].children[j].children[0].classList.add(
            "arrow-" + (i + 1)
          );
        }
        n.children[i].children[0].children[0].children[0].id =
          "title" + (i + 1);
      }
      for (k = 0; k < b.length; k++) b[k].classList.remove("bg-gray-700");
      b[0].classList.add("bg-gray-700");
      ...
      <div
      class="w-[4rem] h-[1rem] max-lg:w-[5rem] mb-5 pb-[1.4rem] max-lg:pb-[2.1rem] text-center border-4 border-black border-yellow-500 bg-yellow-500 text-white rounded-[50%] z-10 font-extrabold"
      id="bar0"
      >
      ${m}
      </div>
      ...
      ><b>head/0</b></div></div>
      <div
      class="w-[4rem] h-[1rem] max-lg:w-[5rem] mb-5 pb-[1.4rem] max-lg:pb-[2.1rem] text-center border-4 border-black border-green-500 bg-green-500 text-white rounded-[50%] z-10 font-extrabold"
      id="bar0"
      >
      ${m}
      </div>
      ...
      <div class="absolute">
        <hr class="w-1 h-5 bg-black bg-yellow-500 border-0 relative top-[-21px] left-8 transition ease-in-out duration-[3s] arrow-0" />
      </div>
      <div class="absolute">
        <hr class="w-1 h-3 bg-black border-0 relative top-[-10px] left-[34px] rotate-45 arrow-0" />
      </div>
      <div class="absolute">
        <hr class="w-1 h-3 bg-black border-0 relative top-[-10px] left-[29px] rotate-[140deg] arrow-0" />
    </div>`;
      n.children[1].children[0].children[0].children[0].innerHTML = "";
      await new Promise((resolve) => {
        msg.addEventListener("end", () => {
          resolve();
        });
  ...
  async function removeB() {
    ...
    if (list.length == 0) {
      ...
      for (k = 0; k < m.children.length; k++) {
        ...
        m.children[k].children[0].children[1].id = "bar" + k;
        m.children[k].children[0].children[0].children[0].id = "title" + k;
        for (let j = 1; j < 4; j++) {
          m.children[k].children[j].children[0].classList.remove(
            "arrow-" + (k + 1)
          );
          m.children[k].children[j].children[0].classList.add("arrow-" + k);
        }
      }
      await new Promise((resolve) => {
        msg.addEventListener("end", () => {
        ...
        <div class="w-[57rem] absolute bottom-[10%] h-[30.5%] flex max-h-option max-sm:hidden">
          ...
          >
            ...
            <button
              ...
              onClick={(e) => {
                e.preventDefault();
                let m = document.getElementById("newPushContainer");
                if (m.classList.contains("hidden")) {
                  let op = [...document.getElementsByClassName("hide")];
                  op.map((v) => {
                    v.classList.add("hidden");
          ...
          <div
            class="ml-[0.5rem] pl-[0.5rem] mt-4 h-8 bg-yellow-300 flex items-center hidden max-h-newList-ins z-50"
            id="newListContainer"
          >
            <button
            ...
            <button
              ...
              onClick={(e) => {
                ...
                let list = [];
                let i,
                  a = parseInt(Math.floor(Math.random()*7)+1);
                for (i = 0; i < a; i++) {
                ...
                list.map((val, ind) => {
                  ...
                  <div class="flex">
                    ...
                    <div
                      class="w-[4rem] max-lg:w-[5rem] mb-5 pb-[1.4rem] max-lg:pb-[2.1rem] text-center border-4 border-black rounded-[50%] z-10 font-extrabold"
                      id="bar${ind}"
                    >
                      ${val}
                    </div>
                  ...
                  <div class="absolute">
                    <hr
                      class=
                        "w-1 h-5 bg-black border-0 relative top-[-21px] left-8 transition ease-in-out duration-[3s] arrow-${ind}"
                    />
                  </div>
                  <div class="absolute">
                    <hr
                      class=
                        "w-1 h-3 bg-black border-0 relative top-[-10px] left-[34px] rotate-45 arrow-${ind}"
                    />
                  </div>
                  <div class="absolute">
                    <hr
                      class=
                        "w-1 h-3 bg-black border-0 relative top-[-10px] left-[29px] rotate-[140deg] arrow-${ind}"
                    />
                  </div>
                </div>`;
                });
                  ...
                  <button
                    ...
                    onClick={(e) => {
                      ...
                      if (regex.test(m.value)) {
                        ...
                        } else alert("Sorry, the maximum size is 7");
                      } else {
                        alert(
                ...
                onClick={(e) => {
                  ...
                  if (list.length <= 6) {
                    ...
                    document
                      .getElementById("subUserInp")
                      .classList.add("hidden");
                    let enq = document.getElementById("newPush").value;
                    insertB(parseInt(enq));
                    document.getElementById("newPush").value = parseInt(
