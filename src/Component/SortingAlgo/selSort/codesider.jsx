...
export default function Codesider() {
  return (
    <div className="w-[27%] h-[23%] py-2 absolute bottom-16 right-[0px] flex justify-end max-h-selcodeSider">
      <div
      ...
      <button
        className="w-[14.2%] bg-green-300 text-[3rem] h-[100%] flex flex-cols justify-center items-center text-center max-h-selcodeSider-btn"
        onClick={(e) => {
